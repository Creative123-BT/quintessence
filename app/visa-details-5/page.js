...
export default function Home() {
  ...
  const handleOnClick = (index) => {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={3} breadcrumbTitle="Spouse/Family Visas">
                ...
                <div className="auto-container">
                    ...
                    <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        ...
                        <div className="sidebar-widget category-widget">
                            ...
                            <li><Link href="visa-details-5" className="current">Spouse/Family Visas</Link></li>
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                        ...
                        <div className="content-one mb_60">
                            ...
                            <figure className="image-box"><img src="assets/images/resource/visa-18.jpg" alt="" /></figure>
